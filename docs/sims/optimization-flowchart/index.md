---
title: Optimization Problem Setup Flowchart
description: An interactive flowchart showing the step-by-step process for setting up optimization problems in calculus, with hover explanations, click examples, and animated walk-through.
quality_score: 85
image: /sims/optimization-flowchart/optimization-flowchart.png
og:image: /sims/optimization-flowchart/optimization-flowchart.png
twitter:image: /sims/optimization-flowchart/optimization-flowchart.png
social:
   cards: false
---
...
[Run the Optimization Flowchart MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
...
5. **Reduce to Single Variable** - Use the constraint to eliminate one variable
6. **Determine Practical Domain** - Find what values make physical sense
7. **Find Critical Points** - Set the derivative equal to zero and solve
8. **Decision: Closed Interval?** - Determines which verification method to use

### Verification Phase (Orange)

8a. **Check Endpoints** (if closed interval) - Compare values at critical points AND endpoints
8b. **Use Derivative Test** (if not closed) - Apply first or second derivative test

9. **State Final Answer** - Give the answer in the context of the original problem with units
