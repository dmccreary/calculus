...
2. **Defining the Derivative of a Function**
...
4. **Connecting Differentiability and Continuity**
...
6. **Derivative Rules: Constant, Sum, Difference, and Constant Multiple**
- Linearity of the derivative
- Combining rules for complex functions
- Efficiency in differentiation

7. **Derivatives of cos(x), sin(x), eˣ, and ln(x)**
...
10. **Finding the Derivatives of Tangent, Cotangent, Secant, and Cosecant**
...
5. **Selecting Procedures for Calculating Derivatives**
...
6. **Approximating Values of a Function Using Local Linearity**
- Tangent line approximation
- Linear approximation formula
- Error estimation

7. **Using L'Hospital's Rule for Indeterminate Forms**
...
2. **Extreme Value Theorem, Global vs. Local Extrema**
- Statement of EVT
...
5. **Interpreting the Behavior of Accumulation Functions**
...
8. **Finding Antiderivatives and Indefinite Integrals**
...
11. **Selecting Techniques for Antidifferentiation** *(BC only)*
...
9. **Logistic Models with Differential Equations** *(BC only)*
...
13. **The Arc Length of a Smooth, Planar Curve and Distance Traveled** *(BC only)*
...
6. **Solving Motion Problems Using Parametric and Vector-Valued Functions**
- Position, velocity, acceleration vectors
- Speed as magnitude of velocity
- Projectile motion

7. **Defining Polar Coordinates and Differentiating in Polar Form**
- Polar coordinate system
- Converting between rectangular and polar
- Derivatives of polar curves

8. **Finding the Area of a Polar Region or the Area Bounded by a Single Polar Curve**
- Polar area formula
- Setting up polar area integrals
- Common polar curves

9. **Finding the Area of the Region Bounded by Two Polar Curves**
...
14. **Representing Functions as Power Series**
- Geometric series manipulations
- Differentiation and integration of power series
- New series from known series

15. **Taylor Series and Maclaurin Series**
