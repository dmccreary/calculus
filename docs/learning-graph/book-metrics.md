...
| MicroSims | 15 | [Simulations](../sims/index.md) | Interactive MicroSims |
...
|-------------|-------------|---------------|-------|
| Diagrams | 110 | 110 | H4 headers starting with '#### Diagram:' |
| Equations | 5919 | 5919 | LaTeX expressions (inline and display) |
| Total Words | 149,492 | 124,763 | Words in markdown files |
| Links | 132 | 63 | Hyperlinks in markdown format |
| Equivalent Pages | 632 | 534 | Estimated pages (250 words/page + visuals) |
