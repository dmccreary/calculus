...
|-------------|-------|------|-------|
| Chapters | 23 | [Chapters](../chapters/index.md) | Number of chapter directories |
| Concepts | 380 | [Concept List](./concept-list.md) | Concepts from learning graph |
| Glossary Terms | 230 | [Glossary](../glossary.md) | Defined terms |
| FAQs | 72 | [FAQ](../faq.md) | Frequently asked questions |
| Quiz Questions | 230 | - | Questions across all chapters |
| MicroSims | 123 | [Simulations](../sims/index.md) | Interactive MicroSims |
...
|-------------|-------------|---------------|-------|
| Diagrams | 124 | 124 | H4 headers starting with '#### Diagram:' |
| Equations | 6502 | 5919 | LaTeX expressions (inline and display) |
| Total Words | 231,642 | 125,121 | Words in markdown files |
| Links | 692 | 63 | Hyperlinks in markdown format |
| Equivalent Pages | 1019 | 592 | Estimated pages (250 words/page + visuals) |
