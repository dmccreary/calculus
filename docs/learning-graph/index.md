...
- **Total Concepts**: 380
- **Foundational Concepts**: 2 (Function, Coordinate System)
- **Taxonomy Categories**: 17
- **Total Dependencies**: 538
- **Longest Learning Path**: 23 concepts
...
- Validates course description has sufficient depth for generating 380 concepts
...
- Foundational concepts: 2 entry points (Function, Coordinate System)
...
- 17 concept taxonomy categories
- Category organization - foundational elements first, advanced techniques last
- Balanced categories (2.9% - 10.3% each)
...
- Balance verification (excellent - 7.4% spread)
