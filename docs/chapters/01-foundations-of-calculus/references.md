# References: Foundations of Calculus

1. [Calculus](https://en.wikipedia.org/wiki/Calculus) - Wikipedia - Broad overview of calculus history, fundamental concepts, and applications. Provides essential context for understanding the scope and significance of the subject introduced in this chapter.

2. [History of calculus](https://en.wikipedia.org/wiki/History_of_calculus) - Wikipedia - Traces the development of calculus from ancient Greek methods through Newton and Leibniz. Directly supports the historical narrative and motivation presented in this chapter.

3. [Function (mathematics)](https://en.wikipedia.org/wiki/Function_(mathematics)) - Wikipedia - Comprehensive treatment of functions including notation, composition, and transformations. Reinforces the prerequisite function concepts reviewed in this chapter.

4. Calculus: Early Transcendentals (9th Edition) - James Stewart - Cengage Learning - Chapter 1 covers functions, models, and the preview of calculus with excellent visual explanations and real-world examples.
